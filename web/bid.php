...
<form>
			...
			<input type="text" class="form-control" value="<?=$sector_name?>">
			</div>
			<div class="form-group">Discription-
			<input type="text" class="form-control" value="<?=$discription?>">
			</div>
...
<div class="chart-area">
       <div class="form-group">TID-
			...
			<input type="text" class="form-control" value="<?=$due_date?>">
			</div>
