...
<body id="page-top">
  ...
  <div id="wrapper">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="col-xl-8 col-lg-7">
              ...
              <div class="form-row">
                <div class="col-md-6">
				  <label for="firstName">Sector Name</label>
                
                  <div class="form-label-group">
                    <input type="text"  class="form-control" name="sector" placeholder="Sector" required="required" autofocus="autofocus">
                    </div>
                </div>
                <div class="col-md-6">
    ...
    <label for="inputPassword">Price</label>
				...
				<div class="form-label-group">
                    <input type="text"  name="inr" class="form-control" placeholder="price" required="required">
                  </div>
                </div>
                <div class="col-md-6">
			...
			<div class="form-label-group">
                <input type="text" id="inputEmail" class="form-control" name="time" placeholder="Time-Duration" required="required">
                 </div>
				 </br>
...
if(isset($_REQUEST['tender']))
{
  ...
  $filenameone = isset($_FILES["fileone"]["name"]) ? basename($_FILES["fileone"]["name"]) : "";
  $tmp_name = isset($_FILES["fileone"]["tmp_name"]) ? $_FILES["fileone"]["tmp_name"] : "";
  $errorone = isset($_FILES["fileone"]["error"]) ? $_FILES["fileone"]["error"] : UPLOAD_ERR_NO_FILE;

  $filenametwo = isset($_FILES["filetwo"]["name"]) ? basename($_FILES["filetwo"]["name"]) : "";
  $tmp_nametwo = isset($_FILES["filetwo"]["tmp_name"]) ? $_FILES["filetwo"]["tmp_name"] : "";
  $errortwo = isset($_FILES["filetwo"]["error"]) ? $_FILES["filetwo"]["error"] : UPLOAD_ERR_NO_FILE;
