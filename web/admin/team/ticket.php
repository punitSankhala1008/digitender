          ...
          <div class="row">
            ...
            <div class="col-xl-8 col-lg-7">
              <div class="card shadow mb-4">
				...
				Priority-
				<select class="form-control " name="priority" id="exampleInputEmail">
				<option>Low
				</option>
				<option>High
				</option>
                ...
                <div class="form-group">
				Department To-
				<select class="form-control " name="department" id="exampleInputEmail">
				<option>Sales
				</option>
				<option>Marketing
				</option>
                  ...
                  <input type="hidden"  value="<?=$_REQUEST['id']?>" name="clientid">
                </div>
                
                <div class="form-group">
				
                  <input type="text" class="form-control" id="exampleInputEmail" name="title" placeholder="Title">
                </div>
				 <div class="form-group">
                  <textarea  class="form-control "  name="discription">Text area...</textarea>
                </div>
                ...
                <input type="submit"  value="Submit" name="ticket" class="btn btn-primary btn-user btn-block">
...
extract($_REQUEST);
echo $query="INSERT INTO `ticket`( `priority`, `department`, `title`, `discription`, `fileone`, `filetwo`, `clientid`) VALUES 
('$priority','$department','$title','$discription','$filenameone','$filenametwo','$clientid')";
