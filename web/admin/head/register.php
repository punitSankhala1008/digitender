        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="col-xl-8 col-lg-7">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary" style="text-align:center">Team Registration</h6>
				...
				<div class="col-sm-6">
					...
					<option >Deartment					</option>
					<option value="sells">Sells
					</option>
            ...
            <div class="col-xl-4 col-lg-5">
			  ...
			  {
				  extract($_REQUEST);
				  $n=iud("INSERT INTO `team`( `name`, `email`, `mobile`, `department`, `password`) VALUES('$name', '$email','$mobile', '$department', '$password')");
				  if($n==1)
				  {
					  echo'<script>alert("successful")
					  window.location="mamber.php?department='.$department.'"
					  </script>';
				  }
			  }
