            ...
            <div class="col-xl-8 col-lg-7">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary" style="text-align:center">Head Login</h6>
                ...
                <div class="card-body">
                  ...
                  <form class="user"  method="post">
                    ...
                    <div class="form-group">
                      <div class="custom-control custom-checkbox small">Department-
...
if(isset($_REQUEST['login']))
	...
	$query="select * from head where email='$email' and password='$password' and department='$department'";
